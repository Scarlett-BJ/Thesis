...
\textbf{CI-MPR} & Cation-independent MPR\\
\textbf{CSF} & Cerebrospinal fluid\\
\textbf{DAPI} & 4',6-Diamidino-2-phenylindole\\
\textbf{[DE]XXXL[LI]} & [Asp-Glu]X-X-X-Leu[Leu-Ile]\\
...
\textbf{GGA} & Golgi-localized, \textgamma ear-containing, ADP ribosylation factor-binding\\
...
\textbf{MPR} & Mannose 6-phosphate receptor\\
...
\textbf{V-ATPase} & Vacuolar-type H\textsuperscript{+}-ATPase\\
\textbf{WT} & Wild-type\\
